...
public class ACalculatorWithThreeValuesShould {
	...
	@Test
	public void HaveTheSecondValueEnteredInItsAccumulatorAfterDrop() {
		calculator.drop();
		assertEquals( value2, calculator.getAccumulator() );
	}

	@Test
	public void HaveTheFirstValueEnteredInItsAccumulatorAfterTwoDrops() {
		calculator.drop();
		calculator.drop();
	...
	@Test
	public void HaveZeroInItsAccumulatorAfterThreeDrops() {
		calculator.drop();
		calculator.drop();
		calculator.drop();
